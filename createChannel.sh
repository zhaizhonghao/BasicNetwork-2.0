...
createChannel(){
    ...
    -f ./artifacts/channel/${CHANNEL_NAME}.tx --outputBlock ./artifacts/channel-artifacts/${CHANNEL_NAME}.block \
...
joinChannel(){
    setGlobalsForPeer0Org1
    peer channel join -b ./artifacts/channel-artifacts/$CHANNEL_NAME.block
